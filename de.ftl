...
failed-to-refresh-fonts-list = Liste der Schriftarten konnte nicht aktualisiert werden
failed-to-convert-text-to-path = Text konnte nicht in einen Pfad umgewandelt werden
...
no-history-items = Keine Einträge in der Historie
