...
export-to-disk = Exportieren auf Festplatte
...
gradient-id = ID des Farbverlaufs
...
image = Bild
import = Importieren
import-from-disk = Importieren von Festplatte
