...
app-description-long =
  ...
  <ul>
    ...
    <li>Manuelle Hilfslinien, intelligente Hilfslinien und Gitternetz</li>
...
subscription-status =
  ...
  .past-due = Überfällig (bitte aktualisieren Sie Ihre Abrechnungsinformationen)
