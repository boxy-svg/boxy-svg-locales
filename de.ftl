...
i-agree-to-tos-and-privacy-policy =
  Ich stimme den <a href="/legal#web-app-terms">Nutzungsbedingungen</a> und der <a href="/legal#web-app-privacy">Datenschutzerklärung</a> zu.
jitter = Flackern
join = Verbinden
...
no-local-fonts-permission = <a href="">Klicken Sie hier</a>, um Boxy SVG die Verwendung Ihrer lokalen Schriften zu erlauben.
...
relevance = Relevanz
reload = Neu laden
reload-from-disk = Neu laden von Festplatte
remove = Eentfernen
...
show-cloud-button = Knopf "Cloud" anzeigen
show-install-button = Knopf "Installieren" anzeigen
