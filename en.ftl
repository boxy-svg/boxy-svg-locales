...
cache-control =
  ...
  .permanent = Permanent
  .custom = Custom
cache-control-hint = Set the "Cache-Control" HTTP header which instructs web browsers how to cache this file.
caching = Caching
cancel = Cancel
...
cant-edit-local-files = Can't edit local files
  .android =
    <p><strong>Android</strong> does not currently allow web apps to open and save local files.</p>
    <p>To make Boxy SVG fully usable please switch to <strong>macOS</strong>, <strong>Windows</strong>,
    <strong>Linux</strong> or <strong>Chrome OS</strong>.</p>
  .brave =
    <p><strong>Brave</strong> browser does not allow web apps to open and save local files.</p>
    <p>To make Boxy SVG fully usable please switch to <strong>Chrome</strong>, <strong>Vivaldi</strong>,
    <strong>Opera</strong> or <strong>Edge</strong> browser.</p>
  .other =
    <p>Your browser does not allow web apps to open and save local files.</p>
    <p>To make Boxy SVG fully usable please make sure your browser is updated to the latest version and
    the <strong>File System Access API</strong> is not disabled in the browser settings.
canvas = Canvas
...
download-on-snap-store = Download on the <strong>Snap Store</strong>
downvote = Downvote
dpi = DPI
drawing = Drawing
drawing-mode =
...
failed-to-star-post = Failed to star post
failed-to-unstar-post = Failed to unstar post
...
failed-to-convert-text-to-path = Failed to convert text to path
  .no-permission = To perform this operation you must first give Boxy SVG permission to acccess your local fonts.
  .no-api = Your browser does not support the <a href="https://boxy-svg.com/blog/15">Local Font Access API</a>.
  .no-font = The font used by this text was not found in the defs or on the local machine.
...
font-weight = Font weight
  .named-100 = Thin
  .named-200 = Extra-light
  .named-300 = Light
  .named-400 = Normal
  .named-500 = Medium
  .named-600 = Semi-bold
  .named-700 = Bold
  .named-800 = Extra-bold
  .named-900 = Ultra-bold
...
install-boxy-svg-hint =
  Boxy SVG is available as a <strong>PWA (Progressive Web App)</strong> which can be installed on your computer
  and used like a regular desktop app.
intercept = Intercept
...
i-agree-to-tos-and-privacy-policy =
  I agree to the <a href="/legal#web-app-terms">Terms of Service</a> and
  the <a href="/legal#web-app-privacy">Privacy Policy</a>.
jitter = Jitter
join = Join
...
share-file = Share file
  .url-hint = Use this URL to share the file with other people or to embed it on other websites.
shift = Shift
shortcut = Shortcut
shortcuts = Shortcuts
  .all = All
...
show-all = Show all
show-ids = Show IDs
show-cloud-button = Show "Cloud" button
...
treat-selection-as-group = Treat selection as group
triangle = Triangle
triangles = Triangles
...
vectorize-tracing = Tracing
  .l-treshold = L treshold
  .q-treshold = Q treshold
  .path-omit = Path omit
